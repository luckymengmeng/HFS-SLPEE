...
# 设置目录
data_Dir = "../../dataset/TCGA_BRCA/TCGA_BRCA_logFC3_logFC0.5_14/geneCpg/"
# 数据，离散格式，行是样本，列为特征
source_file_disc = data_Dir + "merge_CpgExpT_nor_disc.txt"
# 原始融合数据
# 行是属性，列是样本
source_file = data_Dir + "merge_CpgExp_nor.txt"
# 转置后，行是样本，列是属性
source_fileT = data_Dir + "merge_CpgExpT_nor.txt"
# 转置原始数据，行是样本，列是特征
