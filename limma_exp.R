...
# # 设置工作路径
# setwd("../dataset/TCGA_BRCA/geneExp/")
# 输入文件
inputFile="../dataset/bio_contrast/TCGA_BRCA/TCGA_BRCA_logFC3_14/miRNA-low/miRNA.txt" 
# 正常样品的数目
normalNum= 104 
# 癌症样品的数目
tumorNum= 1103
...
write.table(normalData,file="../dataset/bio_contrast/TCGA_BRCA/TCGA_BRCA_logFC3_14/miRNA-low/normalizeExp.txt",
...
# 输出所有基因的表达差异情况
write.table(outTab,file="../dataset/bio_contrast/TCGA_BRCA/TCGA_BRCA_logFC3_14/miRNA-low/allGene.xls",
            sep="\t",row.names=F,quote=F)

# 输出差异基因
outDiff=outTab[( abs(as.numeric(as.vector(outTab$logFC)))>logFCfilter & as.numeric(as.vector(outTab$fdr))<fdrFilter),]
write.table(outDiff,file="../dataset/bio_contrast/TCGA_BRCA/TCGA_BRCA_logFC3_14/miRNA-low/diff.xls",
            sep="\t",row.names=F,quote=F)
